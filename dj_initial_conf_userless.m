function dj_initial_conf_userless()
%Run this to configure needed variables for DataJoint (host, root directories and external storage)
%User and password will not be stored on configuration file (use this on a public machine)
