...
lateral_image=null: blob                  # lateral photo taken for reference
top_image=null:     blob                  # top     photo taken for reference
%}
...
classdef DailyMotorPositionData < dj.Manual
    ...
    methods(Static)
        ...
        function insert_motor_reference_position(subject_fullname, motor_position, lateral_image, top_image)
            ...
            key.capture_time     = datestr(now,'yyyy-mm-dd HH:MM:SS');
