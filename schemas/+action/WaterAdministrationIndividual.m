...
classdef WaterAdministrationIndividual < dj.Manual
    ...
    methods
        ...
        function insert_previous_supplement_from_db_missing_wai(self)
            ...
            for i =1:numel(was)
                ...
                check_wai = struct;
                check_wai.subject_fullname = was(i).subject_fullname;
                check_wai2 = ['administation_type <> "earned" and date(administration_time) = "' was(i).administration_date, '"'];

                previous_record = fetch(self & check_wai & check_wai2);

                if isempty(previous_record) && was(i).supplement ~= 0
                    water_key = struct;
                    water_key.subject_fullname = was(i).subject_fullname;
                    water_key.administration_time = [was(i).administration_date ' 00:00:00'];
                    water_key.administation_type = 'supplement';
