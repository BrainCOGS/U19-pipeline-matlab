...
%{
# Parameters related to thermal manipulation software during session
...
classdef ThermalSoftwareParameter < dj.Lookup
     ...
     methods
        function try_insert(self, key)
            ...
            %try_insert(thermal.ThermalSoftwareParameter, key)
