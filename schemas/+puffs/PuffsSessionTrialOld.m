...
num_puffs_intended_l        : int                           # number of puffs intended on the left side
num_puffs_received_r        : int                           # number of puffs actually received on the right side
num_puffs_intended_r        : int                           # number of puffs intended on the right side
num_puffs_received_l        : int                           # number of puffs actually received on the left side
