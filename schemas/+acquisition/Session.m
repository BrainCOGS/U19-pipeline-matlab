...
classdef Session < dj.Imported
    ...
    methods
        ...
        function insertSessionFromFile_Towers(self,key,log)
            ...
            water_earned_ind_key = struct();
            water_earned_ind_key.subject_fullname = key.subject_fullname;
            updateIndividualWaterEarnedFromFile(action.WaterAdministrationIndividual, water_earned_ind_key, log);
            ...
            if isfield(log.animal, 'pupillometry_video_acq_struct')
                insertSessionVideo(acquisition.SessionVideo, ...
                    session_key,'pupillometry', ...
                    log.animal.pupillometry_video_acq_struct.local_video_name, ...
                    log.animal.pupillometry_video_acq_struct.remote_video_name)
            elseif isfield(log.animal, 'video_acq_struct')
                 insertSessionVideo(acquisition.SessionVideo, ...
                    session_key,log.animal.video_acq_struct.video_type, ...
